---
name: skill-audit
description: ".ax/skills/ 자체의 품질·중복·누락 정기 점검. 한 폴더 = 한 의도 패턴: 한 skill = 한 페르소나/의도. 트리거: 'skill 정리', 'skill audit', 'skill 중복', 'skill 추가/삭제'."
---

# Skill Audit Workflow

`.ax/skills/`는 시간이 가면 비대해진다. 분기 1회 audit으로 정리.
